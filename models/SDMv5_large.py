...
class Modulenet(nn.Module):
    def __init__(self, block, nblocks, graph ,growth_rate=12, reduction=0.5, num_classes=2, core_nums=3):
        ...
        self.linear = nn.Linear(num_planes*25, num_classes)
...
#print(net)
def modulenet_cifar():
    return Modulenet(Bottleneck,[6,12,24,16],graph_matrix, growth_rate=32)
...
def modulenet_Porn_Com():
    return Modulenet(Bottleneck,[6,12,24,16],graph_matrix, growth_rate=20,num_classes=2)
