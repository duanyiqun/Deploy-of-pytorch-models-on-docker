...
class Modulenet(nn.Module):
    def __init__(self, block, nblocks, graph ,growth_rate=12, reduction=0.5, num_classes=2, core_nums=3):
        ...
        self.core_list = [12,12,12]
        self.graph = graph
        num_planes=core_nums*growth_rate
        self.conv1=nn.Conv2d(3, num_planes, kernel_size=9, padding=1, bias=False)
        num_features=[]
        out_planes=[]
...
def modulenet_Porn_Com():
    return Modulenet(Bottleneck,[6,12,24,16],graph_matrix, growth_rate=12,num_classes=2)
