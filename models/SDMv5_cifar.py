...
class Modulenet(nn.Module):
    def __init__(self, block, nblocks, graph ,growth_rate=12, reduction=0.5, num_classes=100, core_nums=3):
        ...
        self.module0_1 = self._make_dense_layers(block, int(self.core_list[0]), nblocks[0] ,self.core_list[0])
        self.module0_2 = self._make_dense_layers(block, int(self.core_list[1]), nblocks[0] ,self.core_list[1])
        self.module0_3 = self._make_dense_layers(block, int(self.core_list[2]), nblocks[0] ,self.core_list[2])
        ...
        num_features[0] = self.cal_output(int(self.core_list[0]), self.core_list[0], nblocks[0])
        out_planes[0] = int(math.floor(num_features[0]*reduction))

        num_features[1] = self.cal_output(int(self.core_list[1]), self.core_list[1], nblocks[0])
        out_planes[1] = int(math.floor(num_features[1]*reduction))

        num_features[2] = self.cal_output(int(self.core_list[2]), self.core_list[2], nblocks[0])
        ...
        self.module1_1 = self._make_dense_layers(block, num_features[0], nblocks[1], self.core_list[0])
        self.module1_2 = self._make_dense_layers(block, num_features[1], nblocks[1], self.core_list[1])
        self.module1_3 = self._make_dense_layers(block, num_features[2], nblocks[1], self.core_list[2])

        num_features[0] = self.cal_output(num_features[0],  self.core_list[0], nblocks[1])
        #print(num_features[0])
        out_planes[0] = int(math.floor(num_features[0]*reduction))
        #print(num_features[0])
        self.trans1_1 = Transition(num_features[0], out_planes[0])
        num_features[1] = self.cal_output(num_features[1],  self.core_list[1], nblocks[1])
        out_planes[1] = int(math.floor(num_features[1]*reduction))
        self.trans1_2 = Transition(num_features[1], out_planes[1])
        num_features[2] = self.cal_output(num_features[2],  self.core_list[2], nblocks[1])
        out_planes[2] = int(math.floor(num_features[2]*reduction))
        ...
        self.module2_1 = self._make_dense_layers(block, num_features[0], nblocks[2],self.core_list[0])
        self.module2_2 = self._make_dense_layers(block, num_features[1], nblocks[2],self.core_list[1])
        self.module2_3 = self._make_dense_layers(block, num_features[2], nblocks[2],self.core_list[2])


        num_features[0] = self.cal_output(num_features[0],  self.core_list[0], nblocks[2])
        out_planes[0] = int(math.floor(num_features[0]*reduction))
        self.trans2_1 = Transition(num_features[0], out_planes[0])
        num_features[1] = self.cal_output(num_features[1],  self.core_list[1], nblocks[2])
        out_planes[1] = int(math.floor(num_features[1]*reduction))
        self.trans2_2 = Transition(num_features[1], out_planes[1])
        num_features[2] = self.cal_output(num_features[2],  self.core_list[2], nblocks[2])
        out_planes[2] = int(math.floor(num_features[2]*reduction))
        ...
        self.module3_1 = self._make_dense_layers(block, num_features[0], nblocks[3] , self.core_list[0])
        self.module3_2 = self._make_dense_layers(block, num_features[1], nblocks[3] , self.core_list[1])
        self.module3_3 = self._make_dense_layers(block, num_features[2], nblocks[3] , self.core_list[2])

        num_features[0] = self.cal_output(num_features[0],  self.core_list[0], nblocks[3])
        #out_planes[0] = int(math.floor(num_features[0]*reduction))
        num_features[1] = self.cal_output(num_features[1],  self.core_list[1], nblocks[3])
        #out_planes[1] = int(math.floor(num_features[1]*reduction))
        num_features[2] = self.cal_output(num_features[2],  self.core_list[2], nblocks[3])
    ...
    def forward(self,x):
        ...
        out = F.avg_pool2d(F.relu(self.bn(out.contiguous())), 4)
...
def modulenet_c10():
    return Modulenet(Bottleneck,[6,12,24,16],graph_matrix, growth_rate=32,num_classes=10)
